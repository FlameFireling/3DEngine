package flamefireling.flamesstuff.threedimensionalengine;
...
public class Texture {
	...
	public static Texture trees = new Texture("res/trees.png", 64);
	public static Texture fence = new Texture("res/fence.png", 64);
}